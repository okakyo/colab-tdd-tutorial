...
def test_en_greeting_at_4_59(mock_en_person):
  current_time = datetime.time(4,59,59)
  print(type(current_time))
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good evening")

def test_en_greeting_at_5_00(mock_en_person):
  current_time = datetime.time(5,0,0)
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good morning")

def test_en_greeting_at_11_59(mock_en_person):
  current_time = datetime.time(11,59,59)
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good morning")

def test_en_greeting_at_12_00(mock_en_person):
  current_time = datetime.time(12,0,0)
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good afternoon")

def test_en_greeting_at_17_59(mock_en_person):
  current_time = datetime.time(17,59,59)
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good afternoon")

def test_en_greeting_at_18_00(mock_en_person):
  current_time = datetime.time(18,0,0)
  greeting_word = mock_en_person.greeting(current_time)
  assert(greeting_word =="Good evening")
